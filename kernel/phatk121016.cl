...
#define s0(n) (S0(Vals[(0 + 192 - (n)) % 8]))
#define S0(n) (rot(n, 30u)^rot(n, 19u)^rot(n,10u))

#define s1(n) (S1(Vals[(4 + 192 - (n)) % 8]))
#define S1(n) (rot(n, 26u)^rot(n, 21u)^rot(n, 7u))

#define ch(n) Ch(Vals[(4 + 192 - (n)) % 8],Vals[(5 + 192 - (n)) % 8],Vals[(6 + 192 - (n)) % 8])
#define maj(n) Ma(Vals[(1 + 192 - (n)) % 8],Vals[(2 + 192 - (n)) % 8],Vals[(0 + 192 - (n)) % 8])

//t1 calc when W is already calculated
#define t1(n) K[(n) % 64] + Vals[(7 + 192 - (n)) % 8] +  W[(n)] + s1(n) + ch(n) 

//t1 calc which calculates W
#define t1W(n) K[(n) % 64] + Vals[(7 + 192 - (n)) % 8] +  W(n) + s1(n) + ch(n)

//Used for constant W Values (the compiler optimizes out zeros)
#define t1C(n) (K[(n) % 64]+ ConstW[(n)]) + Vals[(7 + 192 - (n)) % 8] + s1(n) + ch(n)
...
#define sharoundW(n) Barrier1(n);  Vals[(3 + 192 - (n)) % 8] += t1W(n); Vals[(7 + 192 - (n)) % 8] = t1W(n) + t2(n);  

//SHA round without W calc
#define sharound(n)  Barrier2(n); Vals[(3 + 192 - (n)) % 8] += t1(n); Vals[(7 + 192 - (n)) % 8] = t1(n) + t2(n);

//SHA round for constant W values
#define sharoundC(n)  Barrier3(n); Vals[(3 + 192 - (n)) % 8] += t1C(n); Vals[(7 + 192 - (n)) % 8] = t1C(n) + t2(n);
...
#define P124(n) P2(n) + P1(n) + P4(n)
	...
	//sharound(128 + 0);
	const u Temp2 = (0xb0edbdd0U + K[0]) +  W[128];
	Vals[7] = Temp2 + 0x08909ae5U;
	Vals[3] = 0xa54ff53aU + Temp2;
	
#define P124(n) P2(n) + P1(n) + P4(n)


	W[128 + 16] = + P2(128 + 16) + P4(128 + 16);
	sharound(128 + 1);
	W[128 + 17] = P1C(128 + 17) + P2(128 + 17) + P4(128 + 17);
	sharound(128 + 2);
	W[128 + 18] = P124(128 + 18);
	sharound(128 + 3);
	W[128 + 19] = P124(128 + 19);
	sharound(128 + 4);
	W[128 + 20] = P124(128 + 20);
	sharound(128 + 5);
	W[128 + 21] = P124(128 + 21);
	sharound(128 + 6);
	W[128 + 22] = P4(128 + 22) + P3C(128 + 22) + P2(128 + 22) + P1(128 + 22);
	sharound(128 + 7);
	W[128 + 23] = P4(128 + 23) + P3(128 + 23) + P2C(128 + 23) + P1(128 + 23);
	sharoundC(128 + 8);
	W[128 + 24] =   P1(128 + 24) + P4C(128 + 24) + P3(128 + 24);
	sharoundC(128 + 9);
	W[128 + 25] = P3(128 + 25) + P1(128 + 25);
	sharoundC(128 + 10);
	W[128 + 26] = P3(128 + 26) + P1(128 + 26);
	sharoundC(128 + 11);
	W[128 + 27] = P3(128 + 27) + P1(128 + 27);
	sharoundC(128 + 12);
	W[128 + 28] = P3(128 + 28) + P1(128 + 28);
	sharoundC(128 + 13);
	W[128 + 29] = P1(128 + 29) + P3(128 + 29);
	W[128 + 30] = P3(128 + 30) + P2C(128 + 30) + P1(128 + 30);
	sharoundC(128 + 14);
	W[128 + 31] = P4C(128 + 31) + P3(128 + 31) + P2(128 + 31) + P1(128 + 31);
	sharoundC(128 + 15);
	sharound(128 + 16);
	sharound(128 + 17);
	sharound(128 + 18);
	...
	W[181] += W[172] + Vals[3] + Vals[7] + P2(188) + P1(188) + Ch((Vals[0] + Vals[4]) + (K[59] + W(59+128)) + s1(128+59)+ ch(59+128),Vals[1],Vals[2]) -
		(-(K[60] + H[7]) - S1((Vals[0] + Vals[4]) + (K[59] + W(59+128))  + s1(128+59)+ ch(59+128)));

#define FOUND (0xFF)
#define SETFOUND(Xnonce) output[output[FOUND]++] = Xnonce

#ifdef VECTORS4
	bool result = W[181].x & W[181].y & W[181].z & W[181].w;
	if (!result) {
		if (!W[181].x)
			SETFOUND(W[3].x);
		if (!W[181].y)
